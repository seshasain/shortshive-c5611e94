...
const mockScenes = [
  {
    ...
    visualDescription: "A vibrant underwater coral reef with colorful fish swimming around. Finn, a small bright blue fish with curious eyes, stands out among the others."
  },
  {
    id: '2',
    ...
    visualDescription: "Finn gazes longingly toward the open ocean beyond the reef. Other fish swim contently among the coral, but Finn's posture shows curiosity and wanderlust."
  },
  {
    id: '3',
    ...
    visualDescription: "A powerful current represented by swirling water effects carries Finn away from the colorful reef into darker, more mysterious waters."
  }
];
