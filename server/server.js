...
app.post('/api/refine-story', async (req, res) => {
    ...
    try {
        ...
        const recommendedSceneCount = Math.max(3, Math.ceil(settings.duration / 15));
...
4. Each scene should be roughly 10-15 seconds in duration, with approximately ${recommendedSceneCount} total scenes.
